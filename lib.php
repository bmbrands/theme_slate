...
function theme_slate_process_css($css, $theme) {
 ...
 * @return bool
 */
function theme_slate_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM && ($filearea === 'logo')) {
        $theme = theme_config::load('slate');
 ...
 */
function theme_slate_set_customcss($css, $customcss) {
